...
void ShenandoahBarrierSetAssembler::load_reference_barrier_native(MacroAssembler* masm, Register dst, Address load_addr) {
  ...
  __ li(ra, (int64_t)(uintptr_t)ShenandoahRuntime::load_reference_barrier_native);
  __ la(x11, load_addr);
  __ mv(x10, t1);
  __ jalr(ra);
  __ mv(t1, x10);
...
void ShenandoahBarrierSetAssembler::generate_c1_load_reference_barrier_runtime_stub(StubAssembler* sasm,
  ...
  if (is_native) {
    ...
    __ li(ra, (int64_t)(uintptr_t)ShenandoahRuntime::load_reference_barrier_narrow);
  } else {
    __ li(ra, (int64_t)(uintptr_t)ShenandoahRuntime::load_reference_barrier);
  }
  __ jalr(ra);
  __ mv(t0, x10);
  __ pop_call_clobbered_registers();
...
address ShenandoahBarrierSetAssembler::generate_shenandoah_lrb(StubCodeGenerator* cgen) {
  ...
  if (UseCompressedOops) {
    __ li(ra, (int64_t)(intptr_t)ShenandoahRuntime::load_reference_barrier_narrow);
  } else {
    __ li(ra, (int64_t)(intptr_t)ShenandoahRuntime::load_reference_barrier);
  }
  __ jalr(ra);
  __ mv(t0, x10);
  __ pop_call_clobbered_registers();
